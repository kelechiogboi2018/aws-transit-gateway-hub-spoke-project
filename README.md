...
The following diagram provides a professional visual overview of the AWS Transit Gateway hub-and-spoke design.

![AWS Transit Gateway Hub-and-Spoke Architecture](aws-transit-gateway-architecture.png)
...
> The table records the actual private addressing used during the connectivity tests. Public IP addresses are omitted because they may change and are not required to explain the internal TGW communication.
